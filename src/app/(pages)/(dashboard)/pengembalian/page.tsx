...
import PengembalianTable from '@/components/pengembalian/Pengembalian-table'
import PengembalianDetailSheet from '@/components/pengembalian/Pengembalian-detail-sheet'
...
export default function PengembalianPage() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <PengembalianTable onDetail={handleOpenDetail} />

      <PengembalianDetailSheet open={openDetail} onOpenChange={setOpenDetail} data={selected} />
    </div>
  )
}
